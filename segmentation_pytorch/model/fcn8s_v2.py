...
def init_vggfcn():
    ...
    params['conv1_1.weight'] = vgg16_pretrained['features.0.weight']
    params['conv1_1.bias'] = vgg16_pretrained['features.0.bias']
    params['conv1_2.weight'] = vgg16_pretrained['features.2.weight']
    params['conv1_2.bias'] = vgg16_pretrained['features.2.bias']
    ...
    torch.save(model.state_dict(), '../../pretrained_models/vggfcn_init_v2.pth')
