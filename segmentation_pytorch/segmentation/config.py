...
from segmentation_pytorch.utils.serialization import yaml_load
...
# COMMON CONFIGS
# target domain
cfg.TARGET = 'TASK_UNKOWN'
# Number of workers for dataloading
cfg.NUM_WORKERS = 4
# List of training images
cfg.DATA_LIST = str(project_root / 'segmentation_pytorch/dataset/cityscapes_list/{}.txt')
# Directories
cfg.DATA_DIRECTORY = str('/home/yiren/datasets/UDA/Cityscapes')
...
cfg.TRAIN.INPUT_SIZE = (1024, 512)
# Class info
cfg.TRAIN.INFO = str(project_root / 'segmentation_pytorch/dataset/cityscapes_list/info.json')
...
cfg.TRAIN.OPTIMIZER = 'Adam' # SGD or Adam
cfg.TRAIN.SCHEDULER = 'polynomial' # polynomial or step
...
cfg.TEST.OUTPUT_SIZE = (1024, 512)
cfg.TEST.INFO = str(project_root / 'segmentation_pytorch/dataset/cityscapes_list/info.json')
